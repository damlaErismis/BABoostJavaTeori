...
public class Otomobil {
	...
	// Üye Özellikler
	// Otomobil sınıfından türetilecek her bir nesnenin sahip olabileceği nesneye
	// ait özellikler
	...
	private Motor motor; // Otomobil sınıfının içinde farklı bir sınıfın nesnesini üye değişke olarak
							// tutuyorum
	...
	public Otomobil(String marka, String model, int yil, int aracinKm, int motorHacmi, String saseNo, int yakitTüketimi,
		...
		this.depoHacmi = depoHacmi;
		this.depodakiYakit = 0;
		// this.setMotor(new Motor(motorHacmi, saseNo, yakitTüketimi)); üstteki yerine
		// bu da olurdu.
	}
